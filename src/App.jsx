...
body{font-family:'Times New Roman',serif;font-size:11pt;color:#111;background:#fff;width:210mm;margin:0 auto;}
...
.pagina{
  ...
  padding:42mm 20mm 48mm 20mm;
}
.header{display:none}
h1{text-align:center;font-size:13pt;font-weight:700;text-transform:uppercase;margin:0 0 6px;letter-spacing:1px}
.sec{text-align:center;font-size:10.5pt;font-weight:700;text-transform:uppercase;margin:18px 0 10px;letter-spacing:.5px;border-bottom:1px solid #ccc;padding-bottom:4px}
p{margin-bottom:9px;line-height:1.7;text-align:justify}
table{width:100%;border-collapse:collapse;margin:12px 0;font-size:10pt}
th{background:#0d1e35;color:#fff;padding:7px;text-align:left}
td{padding:6px 8px;border:1px solid #ccc}
tr:nth-child(even)td{background:#f7f9fc}
.ass-wrap{margin-top:40px}
.ass-line{border-top:1px solid #333;margin-top:40px;padding-top:5px;text-align:center;font-size:10pt;line-height:1.6}
.ass-grid{display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-top:6px}
