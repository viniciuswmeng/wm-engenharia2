...
.timbrado-header{width:100%;display:block;margin-bottom:0;}
.timbrado-footer{width:100%;display:block;margin-top:32px;}
.page{padding:0 70px 40px 70px;}
.header{display:none}
@media print{
  .timbrado-header{position:fixed;top:0;left:0;width:100%;}
  .timbrado-footer{position:fixed;bottom:0;left:0;width:100%;}
  .page{padding:180px 70px 140px 70px;}
}
...
<div class="header" style="display:none">
  <div class="h-left"><div class="h-emp"><h2>WM Engenharia Integrada</h2></div></div>
</div>
